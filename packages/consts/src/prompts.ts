...
export const PROMPTS = {
  CHAT: {
    SYSTEM:
      ...
      "If the user's input is very obvious, such as 'I want to lose weight', you should not ask the user for more information and just generate a trackable item for them after acknowledging their input." +
      ...
      "You can also call a tool to generate a new non food/drink consumption trackable item by providing a description of the trackable item." +
      "You should only call the generateNewNonConsumptionTrackable tool once you have enough information to generate a trackable item." +
      "If the user does not already track food and drink consumption, you should call the generateConsumptionTrackables tool to generate a list of trackable items related to food and drink consumption." +
      ...
      "Once you have generated some new trackable items, the user will be shown a list of them automatically in the UI, and they will be able to select which ones they want to track." +
      ...
      EXECUTE: {
        PROMPT: {
          ...
          SYSTEM:
            ...
            "Another Ai model will converse with a user and call you with a description of a single trackable item the user should track." +
            "You will also create a name and description for each trackable." +
            "As an example, if the user wants to improve their mood, you should create a trackable data type for mood, and a trackable data type for anxiety, and a trackable data type for depression, and a trackable data type for journaling." +
            "It is important to set the trackableConfig for each trackable." +
          ...
          // "If you want to track anything related to food and drink consumption, and the user does not already have trackables of type 'consumption', then you should simply return the object with key: 'consumptionTrackablesSkip' set to 'true'.",
        },
      },
    },
  },
