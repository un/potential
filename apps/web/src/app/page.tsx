    ...
    <main className="mx-auto flex max-w-screen-lg flex-col items-center justify-center gap-32 py-32">
      ...
      >
        <div className="flex flex-col items-center justify-center gap-6">
          <h2 className="font-serif text-5xl font-normal">Built around you.</h2>
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          <p className="text-balance text-center text-2xl">
            The longer you use <span>Potential</span>, the smarter it gets — the
            faster your results come to life.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-12">
          <div className="flex flex-row items-center gap-6">
            ...
            <div className="flex max-w-80 flex-col gap-2">
              ...
              <span>
                <span className="decoration-blue-9 underline">Pick a goal</span>{" "}
          ...
          <div className="flex flex-row items-center gap-6">
            ...
            />
            <div className="flex max-w-80 flex-col gap-2">
              <span className="text-2xl font-semibold">Track your signals</span>
              <span>
                Log what the AI asks for, use simple daily check-ins or connect
                wearables.
              </span>
              <span>
                This{" "}
      ...
      <section className="mx-auto flex w-full max-w-4xl flex-col items-center justify-center gap-12 md:grid md:h-[600px] md:grid-cols-5 md:items-stretch">
        <div className="flex h-full flex-1 flex-col items-start justify-center gap-12 md:col-span-3">
          <div className="flex w-full flex-col items-start justify-center gap-6">
            ...
            <h2 className="font-serif text-5xl font-normal">Nothing worked.</h2>
          ...
          <div className="flex flex-col items-start justify-start gap-4">
            ...
            <p className="text-balance text-lg">
              Doctors gave me pills and said, “Try this. Come back in 6 weeks.”
            </p>
            <p className="text-balance text-lg">
